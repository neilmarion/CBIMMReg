...
pasay_locales = ["Malibay", "Pasay", "Proprietarios"].sort
makati_locales = ["Bel-Air", "Evangelista", "Guadalupe", "Jackson", "Makati (Palanan)", "Pembo", "Sacramento"].sort
taguig_pateros_locales = ["Bagumbayan", "Hagonoy", "Lower Bicutan", "Napindan", "Pateros", "Pinagsama", "Signal Village Zone 1", "Signal Village Zone 5", "Taguig", "Tipas", "Upper Bicutan", "Ususan"].sort
paranaque_locales = ["Betterliving", "Ibayo", "Paranaque (UP5)", "Severina 18", "UP1"].sort
laspinas_locales = ["Admiral", "Almanza", "CAA", "Golden Acres", "Las-Pinas (Manuyo)", "Madrigal", "Pamplona", "St. Joseph", "Talon"].sort
muntinlupa_locales = ["Alabang", "Camp Sampaguita", "Cupang", "Karunungan", "Muntinlupa", "New Bilibid Prison (NBP)", "Sucat", "Tunasan", "Victoria"].sort
