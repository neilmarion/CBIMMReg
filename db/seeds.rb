...
taguig_schools = ["AMA Computer Learning Center", "Athens Academy", "Bagumbayan National High School", "Fisher Valley College", "Gen. R. Papa Memorial High School", "Global City Innovative College", "Marichu R. Tiñga High School (TNHS Annex)", "Noah Academy", "Polytechnic University of the Philippines Taguig (PUP-Taguig)", "Saint Francis of Assisi College System Taguig (SFACS Taguig)", "Signal Village National High School", "STI College Taguig", "Taguig City University (TCU)", "Taguig National High School", "Taguig Science High School", "Technological Education and Skills Development Authority Taguig (TESDA Taguig)", "Upper Bicutan National High School", "Technological University of the Philippines (TUP-Taguig)", "Tipas National High School", "Western Bicutan National High School"]
paranaque_schools = ["AMA Computer University", "Baclaran National High School", "Dr. Arcadio Santos National High School", "Escuela de San Dionisio", "Lycee D’Regis Marie School", "Manresa School", "Masville National High School", "Montessori de Manila", "Moonwalk National High School", "Olivarez College", "Parañaque National High School Main (PNHS)", "Parañaque National High School Don Galo Annex (PNHS Don Galo)", "Parañaque National High School La Huerta Annex (PNHS La Huerta)", "Parañaque Science High School", "PATTS College of Aeronautics", "Ramon Pascual Institute (RPI)", "South Merville School", "St. Andrew’s School (STAS)", "St. Paul College of Parañaque", "STI College Parañaque", "Sun Valley National High School", "Universal Colleges of Parañaque", "UP South School"]
laspinas_schools = ["ABE International College of Business and Accountancy", "Augustinian Abbey School Inc.", "Bernardo College", "Blessed Trinity School", "Bloomfield Academy", "Britanny School of Las-Piñas", "CAA National High School Main (CAANHS Main)", "CAA National High School Annex (CAANHS Annex)", "Camella School", "Colegio de Sta. Monica", "Creative Middle School", "Datamex Institute of Computer Technology", "De La Salle Santiago Zobel", "Divine Light Academy (DLA)", "Don Carlo Cavina School", "Dr. Filemon C. Aguilar Memorial College (DFCAMC)", "Dr. Filemon C. Aguilar Information and Technology Training Institute (DFCAITTI)", "Elizabeth Seton School", "Golden Acres National High School (GANHS)", "Imus Computer College", "Las-Piñas College", "Las-Piñas East National High School (LPENHS)", "Las-Piñas East National High School Equitable Annex (LPENHS Equitable)", "Las-Piñas East National High School Talon Annex (LPENHS Talon)", "Las-Piñas National High School (LPNHS)", "Las-Piñas National High School Gatchalian Annex (LPNHS Gatchalian)", "Las-Piñas North National High School (LPNNHS)", "Las-Piñas Science High School (LPSHS)", "Merry Treasure School (MTS)", "O.B. Montessori Center Inc.", "Our Lady of Pilar Montessori Center", "Philippine Merchant Marine School (PMMS)", "Rizal Experimental Station and Pilot School of Cottage Industries Las-Piñas Campus (RESPSCI)", "Saint Francis of Assisi College System Las-Piñas (SFACS-LP)", "Southville International School and Colleges (SISC)", "Southwood Integrated School", "St. Mark’s Institute (SMI)", "STI Academy High School", "STI College Las-Piñas", "University of Perpetual Help System DALTA (UPHSD)", "Westfield Science Oriented School (WSOS)", "TS Cruz High School (TSCHS)"]
...
paranaque_locales = ["Betterliving", "Ibayo", "Parañaque (UP5)", "Severina 18", "UP1"]
laspinas_locales = ["Admiral", "Almanza", "CAA", "Golden Acres", "Las-Piñas (Manuyo)", "Madrigal", "Pamplona", "St. Joseph", "Talon"]
